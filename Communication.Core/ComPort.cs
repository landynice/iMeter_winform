...
namespace Communication.Core
{
    ...
    public class SerialPortCom
    {
        ...
        public bool Send(byte[] byteData)
        {
            ...
            try
            {
                _serialPort.DiscardOutBuffer();//发送前清空传输缓冲区
        ...
        public string Receive()
        {
            ...
            try
            {
                _serialPort.DiscardInBuffer();//接收前清空接收缓冲区
    ...
    //    private const int    MAXFRAMLEN = 1024;        
    //    private const string fourFE     = "FEFEFEFE";//4个字节前导字节
    //    private static SerialPort _SerialPort;

    //    public static event ReceiveFinishHandler ReceiveFinishEven;//声明接收判断是否读完事件
    //    public static event MsgHander MsgEvent;//声明报文处理事件
    ...
    //    static ComPort()
    //    {
    //        _SerialPort = new SerialPort("COM1", 2400, Parity.Even, 8, StopBits.One);
    //        _SerialPort.ReadTimeout     = 2 * 1000;
    //        _SerialPort.WriteTimeout    = 2 * 1000;
    //        _SerialPort.RtsEnable       = true;
    ...
    //    /// 串口初始化
    //    /// </summary>
    //    private static void ComPortInit()
    //    {
    //        //_SerialPort.ReadTimeout = 2 * 1000;
    //        //_SerialPort.WriteTimeout = 2 * 1000;
    //        //_SerialPort.RtsEnable = true;
    ...
    //        //_SerialPort.ReadBufferSize = 1024;
    //        //_SerialPort.WriteBufferSize = 1024;
    //        //_SerialPort = new SerialPort(ComportName, ComportBaudRate, Parity.Even, 8, StopBits.One);
    //    }

    //    /// <summary>
    //    /// 打开串口
    //    /// </summary>
    //    private static void ComOpen()
    //    {
    //        ComClose();
    //        try
    //        {
    ...
    //    /// <param name="txString">要发送的数据</param>
    //    /// <returns>true:成功 false:失败</returns>
    //    public static bool Send(string sendString)
    //    {
    //        ComOpen();
    ...
    //        try
    //        {
    //            ComWriteString(fourFE);//先写4个FE唤醒
    //            ComWriteString(sendString);
    //            MsgEvent(true, fourFE + sendString);
    //        }
    //        catch (Exception ex)
    //        {
    //            ComClose();
    ...
    //    /// <param name="sendBytes">要发送的字节数据</param>
    //    /// <returns>true:成功 false:失败</returns>
    //    public static bool Send(byte[] sendBytes)
    //    {
    //        ComOpen();
    ...
    //            MsgEvent(true, fourFE + sendBytes.ToHexString());
    //        }
    //        catch (Exception ex)
    //        {
    //            ComClose();
    ...
    //                }
    //            }
    //            ret = stream.ToArray().ToHexString();
    //            MsgEvent(false, ret);
    //        }
    //        catch (Exception ex)
    //        {
    ...
    //    /// </summary>
    //    /// <param name="str">string类型数据</param>
    //    private static void ComWriteString(string str)
    //    {
    //        byte[] data = Transfer.StrToByte(str);
    //        try
    //        {
    //            _SerialPort.Write(data, 0, data.Length);
    //        }
